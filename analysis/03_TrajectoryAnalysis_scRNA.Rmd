...
dir.create("./output/03_Trajectories/", showWarnings = F)
```

```{r}
seurat_integrated <-readRDS("./data/QC_dataClustered.filtTyped.rds")
...
ggsave("./output/03_Trajectories/Trajectories_All.svg",gga|ggb|ggc )
...
p
ggsave("./output/03_Trajectories/Trajectories_Lineages.svg",p)
```



```{r}
saveRDS(file="./data/QC_dataClustered.filtTypedTraj.rds", seurat_integrated)
```
