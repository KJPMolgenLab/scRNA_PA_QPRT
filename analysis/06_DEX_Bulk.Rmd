...
alle_restab <- apropos("restab_") # gibt alle wieder die restab beinhalten egal ob groß oder klein schreiben
...
# save info
openxlsx2::write_xlsx(geneInfo,file=paste0(output,'/geneInfoSigned.xlsx'))
