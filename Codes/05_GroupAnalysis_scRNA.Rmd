...
dir.create("./Results/04_Biostat/", showWarnings = F)
```
...
openxlsx2::write_xlsx(DEG_allcells, "./Results/04_Biostat/Biostat_DEG_allcells.xlsx")
...
FeaturePlot(seurat_integrated, features = "H1F0", split.by = "type")
...
openxlsx2::write_xlsx(tablegostres, "./Results/04_Biostat/Biostat_GO_termDEG_all.xlsx")
```
...
for(clus in clusters){
  ...
  openxlsx2::write_xlsx(markers, paste0("./Results/04_Biostat/Biostat_DEG_",clusnam,"cells.xlsx"))
}
...
for(res in names(reslist)){
  ...
  tablegostres = gostres$result[grepl("GO:", gostres$result$source), c("query", "source", "term_name","p_value", "intersection")]
  openxlsx2::write_xlsx(tablegostres, paste0("./Results/04_Biostat/Biostat_GO_termDEG_",res,".xlsx"))
}
```
...
n_cells
openxlsx2::write_xlsx(file="./Results/04_Biostat/Biostat_clusterFreq.xslsx",n_cells)
```
...
lineagesplots
ggsave("./Results/04_Biostat/Biostat_Comparelineages.svg")
